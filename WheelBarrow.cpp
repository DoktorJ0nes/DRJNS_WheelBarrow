...
const BYTE PATTERN1[] = { 0x0F, 0x28, 0xCB, 0x0F, 0x28, 0xC5, 0x0F, 0xC6, 0xC5, 0xFF, 0xF3, 0x0F, 0x58, 0xC8, 0x0F, 0x28, 0xC5, 0x0F, 0xC6, 0xC5, 0xAA, 0xF3, 0x0F, 0x5C, 0xC2, 0xF3, 0x0F, 0x5C, 0xEB,0x00 };
...
void ApplyAllPatches() {
    ...
    if (!failed.empty()) {
		...
		msg += "\nYou can still play the game, but things could go wrong! BE WARNED!\n\n";
    }
